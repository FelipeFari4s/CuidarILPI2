  ...
  Widget _buildComunicacaoEstrategiasContent() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text(
            "A comunicação efetiva é uma das metas do Programa Nacional de Segurança do Paciente, do Ministério da Saúde, e é fundamental para a qualidade da assistência e a segurança dos residentes em Instituições de Longa Permanência para Idosos (ILPIs). "
            "A comunicação é considerada efetiva quando as informações são compartilhadas de forma precisa, completa, registrada e revisada entre os profissionais sempre que necessário, garantindo a exatidão dos dados.",
          ),
          const SizedBox(height: 10),
          const Text(
          ...
          const Text(
            "A comunicação efetiva é essencial para a segurança e o bem-estar das pessoas idosas em ILPIs. O uso de estratégias adequadas pode reduzir incidentes, promover um ambiente mais seguro e melhorar a qualidade do cuidado. "
            "Além disso, um diálogo respeitoso e claro fortalece a confiança entre profissionais e residentes, garantindo uma assistência humanizada.",
          ),
          ...
          const SizedBox(height: 3),
          const Text(
            "Nas ILPIs, a comunicação efetiva entre os profissionais que atuam no cuidado direto ou indireto é essencial para garantir a segurança do residente. Quando há falhas na comunicação, surgem sérios problemas à saúde das pessoas idosas, principalmente devido à sua maior vulnerabilidade. "
            "A comunicação clara e precisa reduz erros e incidentes no ambiente da ILPIs.",
          ),
          const SizedBox(height: 1),

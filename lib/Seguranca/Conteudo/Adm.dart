    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const Text(
              "Para garantir a segurança e evitar esses erros, tem-se os nove certos da administração de medicamentos, que são fundamentais para um cuidado de qualidade."),
          const SizedBox(height: 10),
          const Text(

          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildExpansionTile(
                  title:
                      "Recomendações práticas para o cuidado com alimentação oral",
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
              "⦁ Posição adequada para receber a dieta: a pessoa idosa deve estar sentada na cama ou cadeira, com as costas bem apoiadas."),
          const Text(
          ...
          const Text(
              "⦁ Administração da dieta: o frasco da dieta deve estar pendurado em um suporte, bem mais alto que a pessoa idosa, para facilitar a descida do líquido."),
          const Text(
